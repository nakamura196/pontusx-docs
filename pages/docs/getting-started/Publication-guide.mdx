...
3. Provide file information and click "Submit."
   - **Note:** Only access information is provided; files are never transferred to Pontus‑X. More information about supported data sources can be found [here](https://docs.pontus-x.eu/docs/getting-started/data-service-offerings).
