...
The subgraph is built on top of [The Graph](https://thegraph.com/) and responsible for the extraction of service pricing and purchase history data from the blockchain, subsequent processing of this data, and its storage in a format that allows for straightforward querying via GraphQL.
