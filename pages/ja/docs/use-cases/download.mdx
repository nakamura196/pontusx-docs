...
:::info
Pay close attention to the network you are connected to and ensure you select the correct provider for that network. You can find a list of available providers here: [Pontus-X Networks](/ja/docs/pontus-x-networks/quick-start).
:::
