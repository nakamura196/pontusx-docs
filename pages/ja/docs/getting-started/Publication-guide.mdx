...
3. Provide file information and click "Submit."
   - **Note:** Only access information is provided; files are never transferred to Pontus‑X. More information about supported data sources can be found [here](/ja/docs/getting-started/data-service-offerings).
...
6. (Optional) Provide user-defined parameters, allowlist and/or denylist participants (otherwise, all onboarded participants listed [here](/ja/docs/participants-and-federators/ecosystem-participants) will have access). Provide a license and add a link to asset-specific Terms and Conditions.
7. Click "Continue"
