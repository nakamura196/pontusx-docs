...
- **Application Process:** Get onboarded to the Pontus-X ecosystem by following the [onboarding guide](/ja/docs/getting-started/onboarding-guide). Once onboarded you can launch any number of use cases and services without any further restrictions.
...
- **Application Process:** Follow the steps outlined in our validator [onboarding guide](/ja/docs/pontus-x-networks/node-setup).
...
- **Guidelines:** Review our code contribution guidelines available in the given repositories. See this [list](/ja/docs/technical-architecture/network-details) of core repositores to get started.
