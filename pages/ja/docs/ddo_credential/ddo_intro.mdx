...
You can find out more in the [changelog](/ja/docs/ddo_credential/changelog).
...
More about the on-chain metadata can be found [here](/ja/docs/ddo_credential/on_chain).
...
You can find the full specification of the `OceanEnterpriseServiceCredential` [here](/ja/docs/ddo_credential/ddo_schema).
